...
public class Main {
    ...
    public static void main(String[] args) {
        Product product = new Product("IP","Iphone13promax",33000000,10,"100%");
        Product product1 = new Product("MAC","MacbookPro2021",46000000,20,"100%");
        Product product2 = new Product("IPA","IpadPro2021",28000000,30,"100%");
